const communityLinks = [
  {
    ...
    url: "https://twitter.com/leap_stack",
    stats: "25K followers"
  },
  {
    name: "Discord",
    description: "Join our Discord server and connect with developers",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    url: "https://discord.gg/leap-stack",
    stats: "12K members"
  },
  {
    name: "GitHub",
    ...
    url: "https://github.com/leap-stack",
    stats: "8.5K stars"
  },
  {
    name: "LinkedIn",
    ...
    url: "https://linkedin.com/company/leap-stack",
    stats: "15K followers"
  }
]
    ...
    <div className="mb-24">
      <div className="text-center mb-16">
        ...
        <p className="text-lg text-[#737373] leading-relaxed max-w-2xl mx-auto">
          Connect with developers, share experiences, and stay up to date with the latest from Leap Stack.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4 max-w-5xl mx-auto">
        {communityLinks.map((link, index) => (
          <a
            key={link.name}
            href={link.url}
            className="group rounded-lg border border-[#e0d6c9] bg-[#f8f5f0] p-6 hover:bg-white hover:border-[#2e7d32] transition-all duration-300 hover:shadow-sm"
          >
